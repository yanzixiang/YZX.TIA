...
namespace YZX.Tia.Extensions
{
  ...
  {
    public static T GetOptionalDlc<T>([NotNull] this IWorkingContext workingContext,
  string serviceId)
  where T : class
    {
    ...
    public static T GetRequiredDlc<T>([NotNull] this IWorkingContext workingContext,
      string serviceId)
      where T : class
    {
